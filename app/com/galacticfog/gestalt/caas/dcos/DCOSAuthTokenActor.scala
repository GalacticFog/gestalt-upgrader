...
import com.galacticfog.gestalt.caas.dcos.DCOSAuthTokenActor.{DCOSAuthTokenError, DCOSAuthTokenResponse, InvalidateCachedToken}
...
class DCOSAuthTokenActor @Inject() ( clientFac: WSClientFactory ) extends Actor {
  ...
  override def receive: Receive = {
    case DCOSAuthTokenActor.InvalidateCachedToken =>
...
object DCOSAuthTokenActor {
  ...
  final val actorName = "dcos-auth-token-actor"
